...
export const ClientHeader: React.FC<{
  ...
  return (
    <header className={"sticky w-full top-0 z-20  block bg-white mb-10"}>
        ...
        >
          <div className="flex items-center justify-center space-x-4">
            ...
            <div className=" w-full flex flex-col justify-center items-center ">
              ...
              <div className=" w-full flex flex-col justify-center items-center " onClick={()=>navigate('/dashboard/profile')}>
                <Avatar
                  alt="Remy Sharp"
                  src={client?.profile}
