...
export const SignupFormComponent = () => {
  ...
  const handlePassword = () => {
    setPasswordShow((pass:PasswordType)=>({ password: !pass.password ,confirmPassword:pass.confirmPassword}));
  };
  const handleConfirmPassword = () => {
    setPasswordShow((pass:PasswordType)=>( { confirmPassword: !pass.confirmPassword ,password:pass.password}));
  };
    ...
    <main className="container mx-auto ">
      ...
      <div className="grid xs:grid-cols-2  gap-4">
        <TextField
          ...
          InputProps={{
            startAdornment: <BsPersonCircle className=" text-[1.5rem] mr-2"/>,
          }}
        />
        ...
        <TextField
         size="small"
          ...
          InputProps={{
            startAdornment: <BsGenderAmbiguous  className=" text-[1.5rem] mr-2"/>,
          }}
        >
          ...
          InputProps={{
            ...
            endAdornment: (
              <InputAdornment position="end">
                ...
                >
                  {passwordShow.password ? <IoEyeSharp className="text-[1rem]"/> : <BsEyeSlashFill className="text-[1rem]"/>}
                </IconButton>
              </InputAdornment>
            ),
          }}
